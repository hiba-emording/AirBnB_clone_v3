...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get_state(self):
        """Test get() method for State in FileStorage"""
    ...
    def test_get_city(self):
        """Test get() method for City in FileStorage"""
    ...
    def test_count_all(self):
        """Test count() method for all objects in FileStorage"""
        initial_count = storage.count()
        self.assertGreaterEqual(initial_count, 2)

    def test_count_state(self):
        """Test count() method for State objects in FileStorage"""
        state_count = storage.count(State)
        self.assertGreaterEqual(state_count, 1)

    def test_count_city(self):
        """Test count() method for City objects in FileStorage"""
    ...
    def test_count_file_storage(self):
        """Tests count method for FileStorage"""
        dic = {"name": "Vecindad"}
        state = State(**dic)
        storage.new(state)
        storage.save()
